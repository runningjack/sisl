...
?>
<!-- HEADER -->
<div style="background-image: url('img/header_bg.png'); ">
    <div class="row">
        <div class="col-md-2 col-lg-2 col-sm-2 col ">
            <div style="margin:10px 0;" ><a href="/" alt="Stanbic IBTC Stockbrokers logo" > <img src="img/logo.png"></a></div>
        </div>
...
<section style="background-color: #E1E1E1">
    <div class="row" >
        <div class="col-md-2 col-lg-2 col-sm-2 col-xs-2"  >
            <div style="color: #fff;background-color: #a90329;border-color: #900323;padding: 2px 0px 2px 10px">Latest Price List</div>
        </div>
        ...
        <div class="col-md-10 col-lg-10 col-sm-10 col-xs-10" >
           <div> <div class="marquee">
                ...
                @foreach($pricelists as $pricelist)
                            <span style="display: inline-block;width: 10px;height: 10px;border-radius: 10px;cursor: pointer;margin: 0;background-color: #044893;"></span><span><b>SYMBOL </b>{{rtrim($pricelist->symbol)}} <b>PRE. CLOSE </b> {{rtrim($pricelist->pclose)}} <b>OPEN </b> {{rtrim($pricelist->open)}}
    ...
    <div class="row">
        ...
        <article class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
            @include("includes.hometopsidebar")
        </article>
