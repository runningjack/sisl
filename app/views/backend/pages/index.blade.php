                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    ...
                                    <div class="text-right">
                                     {{HTML::decode(HTML::linkRoute('addnewpage','<span class="btn-label"><i class="glyphicon glyphicon-plus"></i></span> Add New',null,array("class"=>"btn btn-labeled btn-primary")))}}
