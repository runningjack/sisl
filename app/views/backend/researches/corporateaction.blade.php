...
$page_nav["research"]['sub']['corporate']["active"] = false;
include("inc/nav.php");
$breadcrumbs["Research"] ="";
$breadcrumbs["Corporate Action"] ="";
?>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
            <h1 class="page-title txt-color-blue"><i class="fa-fw fa fa-code"></i> Corporate <span>> Action</span></h1>
        </div>
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        ...
                        <div id="dialog_simple" title="Dialog Simple Title">
                            <div id="msg"></div>
                            <p>
                                {{ Form::open(array('url'=>'backend/researches/corporateaction/', 'method'=>'POST', 'class'=>'form-horizontal', 'files'=>true)) }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="input-group">
                                        <input type="date" name="mydate" placeholder="Select a date" class="form-control" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <p class="help-block alert-info">
                                        Ensure that corporate action excel file comforms with the right format provided.
                                    </p>
                                </div>
                        ...
                        <table id="datatable_fixed_column" class="table table-striped table-bordered" width="100%">
                            ...
                            <tr>
                                ...
                                <th class="hasinput icon-addon">
                                    <input id="dateselect_filter" type="text" placeholder="Filter Date Added" class="form-control datepicker" data-dateformat="dd/mm/yy">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#dialog_simple').dialog({
                ...
                resizable : false,
                modal : true,
                title : "<div class='widget-header'><h4><i class='fa fa-warning'></i> Upload New Corporate Action</h4></div>"
