...
$page_nav["frontend"]["sub"]["document"]["sub"]["category"]["active"] = false;
include("inc/nav.php");
                                ...
                                <div id="dialog_simple" title="Dialog Simple Title">
                                    ...
                                    <form>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <section>
                                                    <input type="hidden" id="type" name="type" value="document category" >
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#dialog_simple').dialog({
                ...
                resizable : false,
                modal : true,
                title : "<div class='widget-header bg-color-blueDark'><h4><i class='fa fa-warning'></i> Add New Category</h4></div>",
                buttons : [{
                    html : "<i class='fa fa-save'></i>&nbsp; Save",
                    "class" : "btn btn-success",
                    click : function() {
                        var request =  $.ajax({
                            url:"<?php echo ASSETS_URL ?>/backend/categories/addnew",
                            type:"post",
