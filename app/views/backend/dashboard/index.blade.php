                                ...
                                <div class="widget-body">
                                    ...
                                    <div class="show-stat-microcharts">
                                        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                                            ...
                                            <span class="easy-pie-title"> Sell <i class="fa fa-caret-up icon-color-bad"></i> </span>
                                        ...
                                        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                                            ...
                                            <span class="easy-pie-title"> Buy <i class="fa fa-caret-down icon-color-good"></i></span>
                                            <ul class="smaller-stat hidden-sm pull-right">
                                                <li>
                                        ...
                                        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                                            ...
                                            <span class="easy-pie-title"> Exchange <i class="fa fa-caret-up icon-color-good"></i></span>
                                            <ul class="smaller-stat hidden-sm pull-right">
                                                <li>
                                        ...
                                        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                                            ...
                                            <span class="easy-pie-title"> Rate <i class="fa fa-caret-down icon-color-good"></i></span>
                                            <ul class="smaller-stat hidden-sm pull-right">
                                                <li>
